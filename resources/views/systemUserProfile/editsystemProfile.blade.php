...
@section('title', 'Edit System User Profile')

@section('content')
<div class="col-lg-12">
	<h1 class="page-header">Edit System User Profile</h1>
</div>
	...
	<div class="col-lg-12">
		<div class="panel panel-default">
			<div class="panel-heading">
				Edit System User Profile<a href="{{ url('/applicant/view/users') }}" class="col-2 pull-right" style="text-decoration: none;"><i class="fa fa-arrow-left"></i>&nbsp;Back</a>
			</div>
				...
				<div class="container-fluid">
					<section class="container col-sm-offset-3">
						<div class="container-page">
							<div class="col-sm-6">
								<form role="form" id="sev" action="{{ url('/user/auth/registration_user/'.$users->id.'/edit') }}" method="POST" class="form-horizontal">
									...
									<div class="col-lg-12 center-block">
                                        ...
                                        <div class="form-group">
											...
											<input class="form-control" name="profilephoto" type="file" id="profilephoto" required="required">
										</div>
										<div class="form-group">
